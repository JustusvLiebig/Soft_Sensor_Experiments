...
# 开始搞活
mdl = SAEModel(AEList=[13, 10, 7, 5], sup_epoch=100, unsp_epoch=300, unsp_batch_size=50, sp_batch_size=20, sp_lr=0.04,
               unsp_lr=0.01, device=torch.device('cuda:0'), seed=1024, ss_lambda=1.5).fit(train_x, train_y)
