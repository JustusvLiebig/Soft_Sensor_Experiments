...
mdl = SLSTMModel(dim_X=data.shape[1], dim_y=1, dim_H=90, seq_len=10, n_epoch=60, batch_size=64, lr=0.020, device=torch.device('cuda:0'), seed=1024).fit(X=train_X, y=train_y)
